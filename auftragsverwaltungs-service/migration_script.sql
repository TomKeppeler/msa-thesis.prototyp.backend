...
IF NOT EXISTS (
    ...
    WHERE [MigrationId] = N'20240119110541_mssql_migration_855'
)
BEGIN
    IF SCHEMA_ID(N'auf') IS NULL EXEC(N'CREATE SCHEMA [auf];');
END;
GO
...
BEGIN
    CREATE TABLE [auf].[Capacity] (
        ...
        CONSTRAINT [FK_Capacity_Employee_EmployeeId] FOREIGN KEY ([EmployeeId]) REFERENCES [auf].[Employee] ([Id]) ON DELETE CASCADE,
...
BEGIN
    ...
    VALUES (N'20240119110541_mssql_migration_855', N'8.0.1');
END;
GO
